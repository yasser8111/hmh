...
function DoctorCard({ doc }) {
  return (
    <div
      className={`group bg-white rounded-3xl p-8 flex flex-col justify-between items-center text-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 ${doc.hoverShadow}`}
    >
