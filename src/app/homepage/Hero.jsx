...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl text-right flex flex-col space-y-6 my-auto px-4 sm:px-6 md:px-16 lg:px-24">
      ...
      <div className="relative z-10 w-full pb-6 md:pb-12 pt-16 px-4 sm:px-6 md:px-16 lg:px-24 grid grid-cols-2 md:grid-cols-4 gap-8 text-center bg-linear-to-t from-background to-transparent">
        {stats.map((stat) => (
          <div
            key={stat.id}
